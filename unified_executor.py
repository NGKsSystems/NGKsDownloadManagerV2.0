...
class UnifiedDownloadExecutor:
    ...
    def __init__(self, download_manager_config: Dict[str, Any] = None, download_manager: Optional[DownloadManager] = None):
        """Initialize with download manager configuration or injected instance"""
        # Use injected DownloadManager or create one if standalone
        if download_manager is not None:
            self.download_manager = download_manager
        else:
            # Create ENGINE BASELINE v2.0 HTTP downloader for standalone use
